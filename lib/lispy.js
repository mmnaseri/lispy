...
(function (context) {
    ...
    var Controller = (function () {
        ...
        return {
            remember: function (obj, property) {
                if (!property) {
                    Utils.each(obj, function (value, property) {
                        Controller.remember(obj, property);
                    })
                } else {
                    obj[property].$$hash = hash;
                }
            },
            isOriginal: function (obj, property) {
                return Utils.isObject(obj) && Utils.isDefined(obj[property]) && obj[property].$$hash === hash;
            },
            clean: function (obj) {
                Utils.each(obj, function (fn, name) {
                    obj[name] = Controller.isOriginal(obj, name) ? fn : null;
                });
                Utils.deleteNulls(obj);
            }
        };
    })();
    var Utils = {
